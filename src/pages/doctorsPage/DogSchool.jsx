...
export function DogSchool() {
  return (
    <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-4 max-w-7xl mx-auto w-full mb-20 mt-20 sm:mt-40">
      <h1 className="absolute -top-[4%] sm:-top-[12%] left-20 sm:left-[30%] font-bold text-[20px] sm:text-[45px] text-[#2D3250]">
